...
INPUT_DIR = Path(__file__).resolve().parents[4] / "fixtures" / "seal"
...
def test_preprocessing_pipeline_exports_outputs(tmp_path: Path) -> None:
    """执行印章预处理流程，并把中间结果输出到 pytest 临时目录。"""
    ...
    output_dir = tmp_path / "seal_preprocessing"
