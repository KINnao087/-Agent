...
from core.infrastructure.text import parse_path_to_json_list, pdf2png

TEST_ROOT = PROJECT_ROOT / "test" / "testfiles"
OUTPUT_ROOT = PROJECT_ROOT / "test" / "output" / "pdf2ocrjson"
