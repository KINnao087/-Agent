...
from core.application.contracts.integrity_service import check_contract_integrity, check_contract_all
from core.infrastructure.text import parse_folder_to_json_list
from core.infrastructure.vision.seal.detector import detect_seal_candidates

# TEST_CONTRACT_DIR = ROOT_DIR / "test" / "testfiles" / "contract"
TEST_CONTRACT_DIR = ROOT_DIR / "test" / "testfiles" / "contract1_simulated_tampering"
