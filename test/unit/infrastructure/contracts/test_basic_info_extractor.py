...
import core.infrastructure.contracts.basic_info_extractor as extractor_module
...
def test_extract_contract_basic_info_calls_ai_chain_before_model_mapping(
    ...
    assert calls[1] == ("work_description", extractor_module.BASIC_INFO_EXTRACTION_SYSTEM_PROMPT)
...
def test_extract_contract_basic_info_live_ai_integration() -> None:
    ...
    contract_text = Path("test/fixtures/linearized/contract_linearized.txt").read_text(encoding="utf-8")
